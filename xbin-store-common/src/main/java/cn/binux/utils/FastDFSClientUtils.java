...
public class FastDFSClientUtils {
	...
	public static String upload(File file, String path) {
		...
		try {
			...
			String fileid = storageClient1.upload_file1(file_buff, getFileExt(path), (org.csource.common.NameValuePair[]) meta_list);
	...
	public static String upload(byte[] data, String extName) {
		...
		try {
			...
			storageServer = trackerClient.getStoreStorage(trackerServer);
			storageClient1 = new StorageClient1(trackerServer, storageServer);
			String fileid = storageClient1.upload_file1(data, extName, (org.csource.common.NameValuePair[]) meta_list);
			return fileid;
		} catch (Exception ex) {
			logger.error(ex);
			return null;
